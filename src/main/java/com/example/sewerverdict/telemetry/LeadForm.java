...
public class LeadForm {
	...
	private String recommendedServicePath;
	...
	public String getRecommendedServicePath() {
		return recommendedServicePath;
	}

	public void setRecommendedServicePath(String recommendedServicePath) {
		this.recommendedServicePath = recommendedServicePath;
	}
